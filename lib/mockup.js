...
#comms-inspector .copy-name{margin-left:4px;padding:0 2px;border:0;background:none;color:#63717c;font-size:13px;line-height:1;vertical-align:middle;cursor:pointer}
#comms-inspector .copy-name:hover{color:#145b78}
...
function clearDetailPanels(){content.innerHTML='<p class="empty">Choose Contents, Styles, or Child layouts in the Inspector.</p>';fieldPanel.innerHTML='<p class="empty">Choose a field in Content details.</p>';trail=[];contentOrigin=null}
